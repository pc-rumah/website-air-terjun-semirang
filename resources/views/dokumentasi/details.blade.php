            ...
            <div class="row gy-4">
                    ...
                    <div class="portfolio-details-slider swiper init-swiper">
                        <div class="swiper-wrapper align-items-center">
                            <div class="swiper-slide">
                                <img src="{{ asset('/storage/' . $dokumentasi->thumbnail) }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
                        <h3>Detail</h3>
                        <ul>
                            <li><strong>Nama</strong>: {{ $dokumentasi->nama_pengunjung }}</li>
                            <li><strong>Tanggal</strong>:
                                {{ \Carbon\Carbon::parse($dokumentasi->tanggal)->format('d-m-Y') }}
                            </li>
                            <li><strong>Deskripsi</strong>: "{{ $dokumentasi->deskripsi }}"</li>
                        </ul>
                    </div>
