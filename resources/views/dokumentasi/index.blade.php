    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between">
                <h5 class="card-title fw-semibold mb-4">List Dokumentasi</h5>
                    ...
                    <tbody>
                        @forelse ($dokumentasi as $item)
                            <tr>
                                ...
                                <td>
                                    <h6 class="fw-normal mb-0">{{ $item->nama_pengunjung }}</h6>
                                </td>
                                <td>
                                    <h6 class="fw-normal mb-0">{{ \Carbon\Carbon::parse($item->tanggal)->format('d-m-Y') }}
                                    </h6>
                                </td>
                                <td>
